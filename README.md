...
- **[nook](https://github.com/maxgfr/nook)** — Local-first, encrypted note-taking: nothing leaves the device, and the page itself is forbidden from making any network request (CSP connect-src 'none', enforced in CI). Non-extractable AES-256-GCM key, verifiable full wipe — offline PWA. · [demo](https://maxgfr.github.io/nook/)
