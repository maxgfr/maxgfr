...
<details>
<summary><strong>🤖 AI & dev tooling</strong> · 10</summary>
...
- **[nook](https://github.com/maxgfr/nook)** — Local-first, encrypted note taking: nested pages, wikilinks, backlinks, tags and full-text search behind ⌘K. Nothing leaves the device and the page forbids itself any network request (CSP connect-src 'none', enforced in CI). Non-extractable AES-256-GCM key, verifiable full wipe — offline PWA. · [demo](https://maxgfr.github.io/nook/)
