...
- **[codexify](https://github.com/maxgfr/codexify)** — Codex sidecar toolbelt: model profiles, Ghostty tab attention plus desktop notifications for completed turns and approvals, config backup, keep-awake, and diagnostics (Rust).
...
<details>
<summary><strong>🌐 Web apps & PWAs</strong> · 16</summary>
